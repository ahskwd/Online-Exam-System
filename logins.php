    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		 <!-- Developer Info -->
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Akash Shinde & Team</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">Akash Shinde:-56</h4>
		<h4 style="font-family:'typo' ">Krushna Shinde:-57</h4>
    <h4 style="font-family:'typo' ">Hanmant Karhale:-22</h4>
		<h4 style="font-family:'typo' ">Sudarshan Bhosle:-7</h4>

		<h4 style="font-family:'typo' ">G.H Raisoni Institute Of Engineering And Technology</h4></div></div>
		</p>
      </div>
